            ...
            <tbody>
              {sheets.map((s, i) => (
                <tr key={s.id} style={{ borderBottom: i < sheets.length - 1 ? "1px solid #F6F6F7" : "none" }}>
                  ...
                  <td style={{ padding: "12px 16px" }}>
                    {s.pdf_url ? (
                      <a href={s.pdf_url} target="_blank" rel="noopener noreferrer" style={{ fontSize: "12px", color: "#1A1A1A", fontWeight: 600 }}>View PDF</a>
                    ) : (
                  ...
                  <td style={{ padding: "12px 16px" }}>
                    <div style={{ display: "flex", gap: "8px" }}>
                      <button onClick={() => openEdit(s)} style={{ fontSize: "12px", color: "#1A1A1A", background: "none", border: "none", cursor: "pointer", fontWeight: 600 }}>Edit</button>
