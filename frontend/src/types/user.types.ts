...
export interface UserProfile {
  ...
  // Custom-role permissions from the JWT (null = fixed role): the older plain
  // list of sections, or the current {section: "read" | "write"}.
  scopes?: string[] | Record<string, string> | null;
