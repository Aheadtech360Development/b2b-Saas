...
// Shared page editor — renders both at /admin/storefront/pages/[id] and inline
// inside PagesManager / the new admin shell. Takes the page id + an onBack
// callback instead of reading the route, so it has no navigation assumptions.
