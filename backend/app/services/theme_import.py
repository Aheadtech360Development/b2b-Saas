...
def import_html(html: str, *, name: str) -> dict[str, Any]:
    ...
    # Kept exactly as the design wrote it; the space its own preview toolbar
    # needed is taken out when a page is rendered (services/theme_render.py),
    # so a theme imported before that fix is corrected too.
